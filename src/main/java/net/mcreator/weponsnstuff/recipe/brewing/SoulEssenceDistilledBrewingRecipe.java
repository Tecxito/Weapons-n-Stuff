...
@EventBusSubscriber
public class SoulEssenceDistilledBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new SoulEssenceDistilledBrewingRecipe());
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return new ItemStack(WeponsnstuffModItems.SOUL_ESSENCE.get());
		}
